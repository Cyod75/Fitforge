...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="#"><i class="bi bi-egg-fried"></i> Alimentación</a>
    <a href="#"><i class="bi bi-bar-chart-fill"></i> Progreso</a>
    <a href="#"><i class="bi bi-trophy-fill"></i> Logros</a>
    <a href = '../AUTH/logout.php'><i class="bi bi-door-closed"></i> Salir</a>
  </div>

  <!-- Main Content -->
  <div class="main-content">
    <div class="welcome_rutina">
      <span>A tope con tu <span class="highlight">Rutina</span>!</span>
      <a href="#"class="bi bi-plus-circle icono-derecha"></a>
    </div>
